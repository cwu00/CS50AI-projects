...
def shortest_path(source, target):
    ...
    """
    # using BFS to search for path
    frontier = QueueFrontier()
    start = Node(source, None, None)
    frontier.add(start)    #adds initial state to frontier
    ...
    while frontier.empty() == False:
        ...
        if current.state == target:
            ...
            while current.parent is not None:
                action, state = current.action, current.state
        ...
        # adds neighbours of current to the frontier
    ...
    # frontier is empty and no solution found
    return None
